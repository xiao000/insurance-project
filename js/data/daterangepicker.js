...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        show: function(e) {
			...
			//必须将show方法中的更改，否则当用户选择双日期时若只选择了一个日期然后点击空白处，而下一次再点击input框时就报错了，无法再使用了
        ...
        outsideClick: function(e) {
            ...
            //this.hide();//解决：点击页面其他空白的地方，把之前在日历上选中的日期选择上。（只是隐藏显示，不做任何赋值操作）
            if (this.isShowing){
		        $(document).off('.daterangepicker');
		        $(window).off('.daterangepicker');
		        this.container.hide();
